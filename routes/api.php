...
Route::group(['prefix' => 'v1/'], function ($router) {
    ...
    Route::group(['prefix' => 'user','middleware' => ['auth:sanctum']], function () {
        ...
        Route::post('notifications', [UserController::class, 'getNotification']);
    ...
    Route::group(['prefix' => 'trip_request','middleware' => ['auth:sanctum']], function ($router) {
        ...
        Route::get('reschedule/{id}', [TripRequestController::class, 'reschedule']);
    ...
    Route::group(['prefix' => 'config'], function () {
        ...
        Route::post('check_update', [ConfigController::class, 'checkUpdate']);
