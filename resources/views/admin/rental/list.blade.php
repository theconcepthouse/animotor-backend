        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="rental">
            <div class="modal-content">
                ...
                <div class="modal-body modal-body-md">
                    <h5 class="title">Add New Rental</h5>
...
'])
                            @include('admin.partials.form.text', ['attributes' => 'required','type' => 'number','colSize' => 'col-md-6', 'fieldName' => 'period','title' => 'Period in minutes'])
