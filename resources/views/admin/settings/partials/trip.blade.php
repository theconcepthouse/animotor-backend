        ...
        <div class="row g-3 align-center-">
            ...
            <div class="col-md-12">
                <fiv class="row">
                    ...
                    @include('admin.partials.form.text', ['attributes' => 'required', 'value' => settings('delete_pending_orders_after',3600), 'colSize' => 'col-md-12 mt-3', 'type' => 'number', 'fieldName' => 'set_driver_offline_after','title' => 'Delete pending orders after defined minutes'])
