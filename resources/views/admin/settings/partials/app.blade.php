        ...
        <div class="row g-3 align-center-">
            ...
            <div class="col-md-6">
                <fiv class="row">
                    ...
                    @include('admin.partials.form.select_array', ['attributes' => 'required', 'value' => settings('otp_provider','firebase'), 'colSize' => 'col-md-12', 'fieldName' => 'otp_provider','title' => 'OTP Provider (disabled for testing)', 'options' => ['firebase','disabled']])
