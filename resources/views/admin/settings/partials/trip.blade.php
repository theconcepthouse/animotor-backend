        ...
        <div class="row g-3 align-center-">
            ...
            <div class="col-md-12">
                <fiv class="row">
                    ...
                    @include('admin.partials.form.select_array', ['attributes' => 'required', 'value' => settings('drivers_can_set_radius','no'), 'colSize' => 'col-md-12', 'fieldName' => 'drivers_can_set_radius','title' => 'Allow drivers to set radius', 'options' => ['yes','no']])
