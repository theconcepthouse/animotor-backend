<div class="example-alert mb-3">
    <div class="alert alert-fill alert-danger alert-dismissible alert-icon">
        <em class="icon ni ni-cross-circle"></em> <strong>Complete your setup</strong>! Invalid Firebase settings . <a wire:navigate href="{{ route('admin.settings') }}?active=api">FIX HERE</a>  <button class="close" data-bs-dismiss="alert"></button>
    </div>
</div>
