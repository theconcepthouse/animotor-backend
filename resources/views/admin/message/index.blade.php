                    ...
                    <div class="nk-ibx">
                        <div class="nk-ibx-aside toggle-screen-lg" data-content="inbox-aside" data-toggle-overlay="true"
                            ...
                            <div class="nk-ibx-head">
                                ...
                                <a class="link link-primary" data-bs-toggle="modal" href="#compose-mail"><em
                                        class="icon ni ni-plus"></em> <span>Compose</span></a>
                            </div>
                                            ...
                                            <div class="simplebar-content-wrapper" tabindex="0" role="region"
                                                ...
                                                <div class="simplebar-content" style="padding: 0px;">
                                                    <ul class="nk-ibx-menu">
                                                        <li class="active">
                                                            <a class="nk-ibx-menu-item"
                                                               href="{{ route('admin.message.index') }}" wire:navigate>
                                                                <em class="icon ni ni-inbox"></em>
                                                                <span class="nk-ibx-menu-text">Inbox</span>
                                                                <span
                                                                    class="badge rounded-pill bg-warning">{{ $inboxCount }}</span>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="nk-ibx-menu-item"
                                                               href="{{ route('admin.message.sent') }}" wire:navigate>
...
{{--                                                                <span--}}
{{--                                                                    class="badge rounded-pill bg-danger badge-dim">8</span>--}}
{{--                                                            </a>--}}
{{--                                                        </li>--}}
                                                    </ul>
                                                </div>
                                ...
                                <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
                                    <div class="simplebar-scrollbar"
                                         style="height: 29px; transform: translate3d(0px, 0px, 0px); display: block;"></div>
                                </div>
                            </div>
                        </div>
                        <!-- .nk-ibx-aside -->
                                    ...
                                    <ul class="nk-ibx-head-tools g-1">
                                        ...
                                        <li class="me-n1 d-lg-none">
                                            <a href="#" class="btn btn-trigger btn-icon toggle"
                                               data-target="inbox-aside"><em class="icon ni ni-menu-alt-r"></em></a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="nk-reply-form-editor">
                                <div class="nk-reply-form-field">
                                    <input type="text" id="subject" name="subject"
                                           class="form-control form-control-simple" placeholder="Subject"/>
                                </div>
                                <div class="nk-reply-form-field">
