            ...
            <div class="nk-content-inner">
                <div class="nk-content-body">
                     <div class="container mb-3 mt-4">
                         <h4>VRM: <a href="" class="btn btn-warning">{{ $pcn->vrm }}</a></h4>
                     </div>
                                        ...
                                        <div class="card-inner p-0">
                                            ...
                                            <div class="container mt-5">
                                                <div class="form-container">
                                                   ...
                                                   <form class="px-5" action="{{ route('admin.pcns.storePcnLog') }}" method="POST">
                                                       @csrf
                                                       ...
                                                       @if(session()->has('message'))
                                                        ...
                                                        @endif
                                                       <input type="hidden" name="pcn_id" value="{{ $pcn->id }}">
                                                    <div class="row">
