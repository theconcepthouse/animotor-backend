                                 ...
                                 <div class="card card-bordered card-preview">
                                    ...
                                    <div class="card-inner">
                                        <ul class="nav nav-tabs mt-n3" >
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link active btn btn-primary" href="{{ route('admin.driverDocuments', $driver->id) }}" wire:navigate>Documents</a>
                                            </li>
                                            <li class="nav-item" >
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="card card-bordered mb-2">
                                                                <div class="card-inner">
                                                                    ...
                                                                    <div>
                                                                        <img height="80" width="100" src="{{ asset($documentPath ?? 'img/placeholder.jpg') }}" class="img-fluid" alt="{{ ucwords(str_replace('_', ' ', $documentType)) }}">
                                                                    </div>
