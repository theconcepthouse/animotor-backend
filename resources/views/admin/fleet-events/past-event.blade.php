                    ...
                    <div class="nk-block">
                        <div class="card card-bordered">
                            <ul class="nav nav-tabs nav-tabs-s2">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " wire:navigate href="{{ route('admin.currentEvent') }}">Current Event</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" wire:navigate  href="{{ route('admin.pastEvents') }}" >Past Event</a>
                                </li>
                            </ul>
